...

{
  ...
  programs.fzf = {
    ...
    changeDirWidget = {
      ...
      options = ["--border --border-label ' Directorios ' --style full --preview 'tree -C {} | head -200'"];
    };
    ...
    fileWidget = {
      ...
      options = ["--border --border-label ' Archivos ' --style full --preview 'bat --style=numbers --color=always {}'"];
    };
};
}
